...
const IconCard: React.FC<Props> = ({
  ...
  const fallbackIcon =
    key.includes("gift") || key.includes("souvenir")
      ? IoGiftOutline
      : key.includes("apparel") || key.includes("uniform") || key.includes("cloth")
      ? IoShirtOutline
      : key.includes("toy") || key.includes("game")
      ? IoGameControllerOutline
      : key.includes("swat")
      ? IoShieldOutline
      : IoGridOutline;
    ...
    >
      ...
      >
        {typeof iconUrl === "string" && iconUrl ? (
          ...
          <div
            className={cn("mb-0 flex justify-center items-center text-gray-700", {
