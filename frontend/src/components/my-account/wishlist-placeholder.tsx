  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between gap-4 border-b border-gray-100 pb-5 mb-6">
        ...
        <Link
          href={ROUTES.HOME}
          className="text-sm font-semibold bg-[#212121] text-white px-4 py-2 inline-block rounded hover:bg-gray-600 transition whitespace-nowrap font-body"
        >
          Browse Products
        </Link>
      </div>
                  ...
                  <div className="flex items-center gap-4 md:gap-6 flex-1 min-w-0">
                    ...
                    <div className="min-w-0 flex-1">
                      <Link
                        ...
                        className="text-sm md:text-base font-semibold text-heading hover:text-[#C7844B] transition line-clamp-2 leading-snug font-body"
                      >
                        {product?.name}
                      </Link>
